...
// ----------------------------------------------------------------------------------
/* Упражнение 2
    В строке 7, обьявлены только указатели без инициализации, то есть нет указания на адреса.
    В строке 10 разыменовываем неициниализированные указатели
    11 строка, сравниваем адреса а не значения (*x>*y) 
    13 cтрока, присваиваем указатели. *x=*y
    15 строка, опять таки сравниваем адреса между собой
    17 строка, снова идет присвоение указателя
    19 строка, сравнение адресов
    21 строка, присваиваем указатель
    24 строка, выводим адреса в памяти а не значения.
    */

// Упражнение 2.1
void increase(int& ref, int* ptr) {
    ref++;
    (*ptr)++;
}
 int main() {
